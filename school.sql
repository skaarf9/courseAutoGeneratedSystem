...
CREATE TABLE `s_class`  (
  `s_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '班级id',
...
CREATE TABLE `s_classroom`  (
  `s_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '教室id',
  `s_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '教室名称',
  `s_capacity` tinyint(3) UNSIGNED NOT NULL COMMENT '教室大小',
  PRIMARY KEY (`s_id`) USING BTREE
...
INSERT INTO `s_classroom` VALUES (6, '1202', 4);
...
CREATE TABLE `s_subject`  (
  `s_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '学科id',
  `s_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '学科名称',
  `s_workload` tinyint(4) UNSIGNED NOT NULL COMMENT '学科工作量(单位班)',
  `s_duration` int(11) UNSIGNED NOT NULL COMMENT '学科总课时',
  `s_weeklyLessonNum` tinyint(4) UNSIGNED NOT NULL COMMENT '每周课时',
  PRIMARY KEY (`s_id`) USING BTREE
...
-- ----------------------------
INSERT INTO `s_subject` VALUES (1, '语文', 1, 30, 4);
INSERT INTO `s_subject` VALUES (2, '数学', 1, 30, 4);
INSERT INTO `s_subject` VALUES (3, '英语', 1, 30, 4);
INSERT INTO `s_subject` VALUES (4, '物理', 2, 16, 3);
INSERT INTO `s_subject` VALUES (5, '化学', 4, 21, 3);
INSERT INTO `s_subject` VALUES (6, '历史', 4, 15, 1);
INSERT INTO `s_subject` VALUES (7, '生物', 4, 17, 3);
INSERT INTO `s_subject` VALUES (8, '地理', 3, 19, 2);
INSERT INTO `s_subject` VALUES (9, '政治', 3, 24, 2);
INSERT INTO `s_subject` VALUES (10, '体育', 3, 14, 2);
...
CREATE TABLE `s_teacher`  (
  `s_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '教师id',
  `s_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '教师名称',
  `s_workload` tinyint(4) UNSIGNED NOT NULL COMMENT '教师工作量(单位course)',
...
-- ----------------------------
INSERT INTO `s_teacher` VALUES (1, '张三', 7, '1,6,8,7,4,9,1,3,10,9');
INSERT INTO `s_teacher` VALUES (2, '李四', 6, '7,4,10,1,9,6,10,5,2,8');
INSERT INTO `s_teacher` VALUES (3, '王五', 6, '1,1,8,3,6,1,1,0,10,7');
INSERT INTO `s_teacher` VALUES (4, '周润发', 4, '4,8,3,10,4,8,10,0,1,2');
INSERT INTO `s_teacher` VALUES (5, '谢婧婷', 5, '4,1,10,9,0,8,0,3,10,4');
INSERT INTO `s_teacher` VALUES (6, '郑和', 5, '1,6,4,6,0,9,5,6,1,7');
INSERT INTO `s_teacher` VALUES (7, '杨和宇', 9, '5,6,10,1,5,0,6,5,5,10');
INSERT INTO `s_teacher` VALUES (8, '哈根听', 6, '3,5,5,9,2,4,1,0,10,3');
INSERT INTO `s_teacher` VALUES (9, '安秀英', 7, '9,3,2,7,1,6,5,6,2,9');
